...
Permettre une meilleure intégration avec autobill qui est écrit en OCaml et permettre une compatibilité avec les deux architectures du projet.
...
Une autre divergence avec la spécification est que nous avons utilisé une traduction récursive terminale par souci d'optimisation.
