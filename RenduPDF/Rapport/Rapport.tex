...
Nous avons également rencontré quelques difficultés pour faire avancer le projet. Tout d'abord, nous n'avons pas été en mesure de construire un pipeline MiniML $\rightarrow$ LCBPV $\rightarrow$ Autobill $\rightarrow$ Équation $\rightarrow$ Résolution, avec le lien Autobill $\rightarrow$ Équation est toujours en progress. Et finalement nous ne pouvons pas comparer notre solution avec celle de J.Hoffmann et l'interface de RAML. Deuxièmement, notre projet avance en parallèle avec H.Suzanne et nous devons être totalement immergés dans le sujet de recherche. Mais nous devions aussi travailler sur plusieurs projets en même temps, et nous avons eu beaucoup de challenge de gestion de temps. \\
